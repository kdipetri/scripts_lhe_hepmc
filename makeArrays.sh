...
python test_hepmc.py --mass "600" --lifetime "0p1ns"   --nevents ${nevents}
python test_hepmc.py --mass "600" --lifetime "0p01ns"  --nevents ${nevents}
python test_hepmc.py --mass "600" --lifetime "0p001ns" --nevents ${nevents}

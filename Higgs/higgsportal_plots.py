...
f = open('higgsportal_effieciencies.json',)
data = json.load(f)
...
for i in range(len(lt_list)):
    for j in range(len(pt_list)):
        ...
        fig.savefig('Higgsportal_eff_' + str(lt_list[i]) + '_pt' + str(pt_list[j]) + '.pdf', filetype = '.pdf')
...
for i in range(len(lt_list)):
    for j in range(len(d0_list)):
        ...
        axs.legend(fontsize = "small", frameon = False)
        fig.savefig('Higgsportal_eff_' + str(lt_list[i]) + '_d0' + str(d0_list[j]) + '.pdf', filetype = '.pdf')
...
for i in range(len(lt_list)):
    ...
    fig.savefig('Higgsportal_avg_energy_' + str(lt_list[i]) + '.pdf', filetype = '.pdf')
...
for i in range(len(lt_list)):
    ...
    fig.savefig('Higgsportal_avg_dist_' + str(lt_list[i]) + '.pdf', filetype = '.pdf')
...
for i in range(len(lt_list)):
    ...
    fig.savefig('Higgsportal_avg_pt_' + str(lt_list[i]) + '.pdf', filetype = '.pdf')
...
for i in range(len(lt_list)):
    ...
    fig.savefig('Higgsportal_avg_d0_' + str(lt_list[i]) + '.pdf', filetype = '.pdf')
...
for i in range(len(lt_list)):
    for j in range(len(mass_list)):
        ...
        bebo = 0
        title = "Higgsportal_energy_" + str(lt_list[i]) + "_" + str(mass_list[j]) + ".pdf"
        fig,axs = plt.subplots()
        ...
        fig.savefig(title, filetype = '.pdf')
...
for i in range(len(lt_list)):
    for j in range(len(mass_list)):
        ...
        title = "Higgsportal_decay_dist_" + str(lt_list[i]) + "_" + str(mass_list[j]) + ".pdf"
        fig,axs = plt.subplots()
...
for i in range(len(lt_list)):
    for j in range(len(mass_list)):
        ...
        title = "Higgsportal_trans_decay_dist_" + str(lt_list[i]) + "_" + str(mass_list[j]) + ".pdf"
        fig,axs = plt.subplots()
...
for i in range(len(lt_list)):
    for j in range(len(mass_list)):
        ...
        for k in hist_pt:
            if k[0] == i and k[1] == j:
                spec_pt.extend(k[2])
        title = "Higgsportal_pt_" + str(lt_list[i]) + "_" + str(mass_list[j]) + ".pdf"
        fig,axs = plt.subplots()
...
for i in range(len(lt_list)):
    for j in range(len(mass_list)):
        ...
        for k in hist_d0:
            if k[0] == i and k[1] == j:
                spec_d0.extend(k[2])
        title = "Higgsportal_d0_" + str(lt_list[i]) + "_" + str(mass_list[j]) + ".pdf"
        fig,axs = plt.subplots()
...
for i in range(len(lt_list)):
    for j in range(len(mass_list)):
        ...
        for k in hist_eta:
            if k[0] == i and k[1] == j:
                spec_eta.extend(k[2])
        title = "Higgsportal_eta_" + str(lt_list[i]) + "_" + str(mass_list[j]) + ".pdf"
        fig,axs = plt.subplots()
...
for i in range(len(cf_masses)):
    title = "Higgsportal_cf_pT_" + str(cf_masses[i]) + "_" + str(cf_lifetimes[i]) + ".pdf"
    fig,axs = plt.subplots()
...
for i in range(len(cf_masses)):
    title = "Higgsportal_cf_d0_" + str(cf_masses[i]) + "_" + str(cf_lifetimes[i]) + ".pdf"
    fig,axs = plt.subplots()
    axs.set_title("Surviving Events (mass: " + str(cf_masses[i]) + ", lifetime: " + str(cf_lifetimes[i]) + ")")
    axs.set_ylabel("Events")
    axs.set_yscale("log")
...
for i in range(len(cf_masses)):
    title = "Higgsportal_cf_fullcuts_" + str(cf_masses[i]) + "_" + str(cf_lifetimes[i]) + ".pdf"
    fig,axs = plt.subplots()
    axs.set_title("Surviving Events (mass: " + str(cf_masses[i]) + ", lifetime: " + str(cf_lifetimes[i]) + ")")
    axs.set_ylabel("Events")
    axs.set_yscale("log")

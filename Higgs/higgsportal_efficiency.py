...
file_list = glob.glob("/eos/user/k/kpachal/TrackTrigStudies/RunDirectories/run_higgsportal/higgsportal_125_*/events.hepmc")
...
with open('higgsportal_effieciencies.json', 'w') as fp:
  json.dump(data, fp)
